...
def sample_df():
    data = {
        "Дата операции": ["01.01.2023 12:00:00", "07.01.2023 15:30:00", "15.01.2023 10:15:00", "25.01.2023 18:45:00"],
...
def mock_df1():
    ...
    data = [
        ...
        {
            "Дата операции": "2023-01-02 13:00:00",
            "Сумма платежа": -200,
        ...
        {
            "Дата операции": "2023-01-04 15:00:00",
            "Сумма платежа": -400,
            "Категория": "Одежда",
            "Описание": "Новая куртка",
        },
        {
            "Дата операции": "2023-01-05 16:00:00",
            "Сумма платежа": -500,
